...
1. Create the database and run `00_schema.sql`
2. Update the file paths in `01_load_data.sql` to your local `data/` folder, then run it
3. Run `02` through `05` in order
